                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <a class="sidebar-link" href="{{url('table')}}" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{url('signout')}}" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{url('registration')}}" aria-expanded="false">
                                <span>
